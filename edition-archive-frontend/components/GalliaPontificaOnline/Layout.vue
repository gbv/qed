          ...
          <ul class="navbar-nav">
              ...
              <ul class="dropdown-menu">
                <li>
                  <nuxt-link
                    class="dropdown-item"
                    active-class="active"
                    href="/gallia-pontifica-online/regesten/reims1/">
            ...
            <li class="nav-item">
              <nuxt-link
                class="nav-link"
                active-class="active"
                href="/gallia-pontifica-online/publikationen">
            ...
            <li class="nav-item">
              <nuxt-link
                class="nav-link"
                active-class="active"
                href="/gallia-pontifica-online/zitieren">
            ...
            <li class="nav-item">
              <nuxt-link
                class="nav-link"
                active-class="active"
                href="/gallia-pontifica-online/kontakt">
  ...
  <div
    ...
    <div class="col-12 gpo-sub-headline">
      <h2>
        ...
        <span v-else-if="$route.params.regesten == 'genf1'">
          {{ $t('gpo.pages.regesta.genf1.headline') }}
        </span>
