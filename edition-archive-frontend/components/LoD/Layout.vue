...
<div :class="$route.params.lodPath == '' ? 'project-headline project-headline--home':'project-headline'">
    <div class="container">
      <div class="row ">
  ...
  <div class="container">
    ...
    <div class="row">
            ...
            <ul class="nav nav-pills qed-sub-menu">
              ...
              <li class="nav-item">
                <nuxt-link
                  class="nav-link"
                  active-class="active"
                  href="/languages-of-diplomacy/project">
                  {{ $t('lod.mainMenu.project') }}
              </nuxt-link>
              </li>
              <li class="nav-item">
                <nuxt-link
              ...
              <li class="nav-item">
                <nuxt-link
                  class="nav-link"
                  active-class="active"
                  href="/languages-of-diplomacy/indices/people">
      ...
      <div class="col-auto">
        <div class="project-institute project-institute--lod">
