...
export default defineNuxtConfig({
    ...
    runtimeConfig: {
        public: {
            ...
            cms: 'https://ditav.gbv.de/',
            cmsServer: 'https://ditav.gbv.de/',
            ...
            geonamesURL: 'https://ditav-test.gbv.de/api/geonames/',
            geonamesURLServer: 'https://ditav-test.gbv.de/api/geonames/'
        }
    },
    typescript: {
        /* strict: true, */
